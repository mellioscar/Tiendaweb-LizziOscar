...
function ImageFumigaciones({greeting}) {
    ...
    const imageUrl3 = '../images/Fumigacion-3.jpg'
    ...
    return (
        <div>
            ...
            <div style={{display:'flex', justifyContent:"space-around", alignItems:'center'}}>
                ...
                <img src={imageUrl3} alt="Imagen Fumigaciones 2" style={{borderRadius: "15px"}}/>
                <img src={imageUrl2} alt="Imagen Fumigaciones 3" style={{borderRadius: "15px"}}/>
            </div>
        </div>
    );
}
